...
SYSTEM_PROMPT = (
    ...
    "дроби как a/b или «в числителе … в знаменателе …», производные как f'(x), корень как √ или «корень из». "
    "Логарифмы: «log₂ 15» или текстом «логарифм по основанию 2 от 15», не \\log_2. "
